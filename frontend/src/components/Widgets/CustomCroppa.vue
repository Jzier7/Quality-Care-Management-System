<template>
  <div>
    ...
    <div v-if="!imgUrl" class="col-span-4 mb-4 w-full">
      <div v-if="!cropping" @dragover.prevent @drop.prevent="onDrop" @click="$refs.fileInput.click()"
      ...
      <cropper ref="cropper" class="cropper" :src="img" :stencil-size="stencilSize" :stencil-props="stencilProps" />
    ...
    <div v-if="imgUrl" class="mt-4">
      <img :src="imgUrl" alt="Cropped Image" class="w-full mb-4" :class="{ 'circular-image': isCircular }" />
